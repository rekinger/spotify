...
export default function Mixer() {
    ...
    return (
        <div className="flex flex-1 relative w-11/12 sm:w-5/6 px-2 sm:px-6 flex-col page-body gap-y-4">
            ...
            <div className="flex flex-col items-center px-2 py-2 min-h-20 overflow-scroll overflow-x-hidden">
                <AnimatePresence>
                    {
                    ...
                    }
                    {
                        ingredients.length > 0 ? (
                            <motion.div exit={{opacity:0}}>
                                ...
                                <Modal scrollBehavior="inside" size={"2xl"}  className='z-50' isOpen={isOpen} onOpenChange={onOpenChange}>
                                    <ModalContent>
                                        <ModalBody>
                                        <p> 
